        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-green-400 mb-4">
              I&apos;m P. Yashaswin Sharma, a passionate software engineer with
              a love for creating innovative solutions and building exceptional
              user experiences. With expertise in full-stack development, I
              enjoy working with modern technologies to bring ideas to life.
            </p>
